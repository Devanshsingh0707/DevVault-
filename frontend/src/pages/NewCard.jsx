...
const NewCard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast('Knowledge note created successfully!', 'success');
      navigate('/');
    } catch (error) {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder="e.g. Binary Search algorithm, Git merge vs rebase"
              value={title}
          ...
          <div className="form-group">
            ...
            <textarea
              className="form-control"
              placeholder="Enter explanation, description, or notes..."
              rows={4}
              value={description}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
            ...
            <div className="form-group">
              ...
              <input
                type="text"
                className="form-control"
                placeholder="dsa, binary-search, search"
                value={tagsInput}
